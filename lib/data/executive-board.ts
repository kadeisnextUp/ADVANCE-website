...
export const executiveBoard: ExecutiveBoardMember[] = [
  ...
  },
  {
    ...
    bio: "The Vice President serves as second-in-command of ADVANCE, leading in the President's absence and collaborating with the President, Advisory Board Chair, and Cabinet to achieve organizational goals. They oversee department directors across all areas, delegate assignments, and ensure effective execution of initiatives. The role includes coordinating major events, conducting performance evaluations of Vice Presidents, and promoting member engagement at the director level. Additionally, the EVP drives professional development, leads special projects, and takes initiative on approved goals to advance the organization.",
  },
  {
  ...
  },
  {
    id: 'outreach-chair',
    name: 'Zoeria Logan',
    role: 'Director of Outreach Chair',
    photo: null,
    team: 'external',
  ...
  },
  {
    ...
    bio: "The Director of Digital Technology reports to the Vice President of Internal Affairs and oversees all technological operations within ADVANCE. They led the development of the website and manage the Digital Technology committee (ADVANCE Devs), maintaining the organization's online platforms and ensuring smooth digital communication. The role also includes preparing presentations for events and collaborating with the Marketing and Human Resources Departments on newsletters and member directories. Overall, the director leads tech initiatives that enhance efficiency and supports the organization's digital growth.",
  },
];
